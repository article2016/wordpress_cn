...
<body id="body">
<div id="T_Navigation">
	<a id="localhost" class="h1" href=""><i class="ico_localhost"></i> localhost</a>
...
<script src="View/js/swfupload/swfupload.js"></script>
<script src="View/js/swfupload/swfupload.queue.js"></script>
<script src="View/js/swfupload/AmysqlUploadObject.js"></script>
