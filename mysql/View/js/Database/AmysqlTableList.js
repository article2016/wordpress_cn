...
var TableData = function ()
{
	...
	this.show = function ()
	{
		...
		if(CanEdit)
		{
			...
			this.htr.appendChild(C('th',{'innerHTML':'No.'},{'padding':'5px'}));
		}
		...
		for (var k in this.ThItem)
		{
			...
			var FName = k;
			var Ftitle = '';
			if(FName == 'Auto_increment') 
			{
				FName = 'AI.';
				Ftitle = 'Auto Increment';
			}
			this.ThItem[k].ATag = C('span',{'innerHTML': FName, 'title':Ftitle});	// 标题文字
